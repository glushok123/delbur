            ...
            <div class="container">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="register-email" placeholder="">
                    </div>
                    <br>
                    <div class="form-group">
                    ...
                    <br>
                    <div class="form-group">
                        <input class="form-check-input" type="checkbox" value="" id="register-type">
                ...
                <br>
                <div class="row text-center">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#loginModal">Уже есть аккаунт? Войти</a>
                </div>
            </div>
        </div>
